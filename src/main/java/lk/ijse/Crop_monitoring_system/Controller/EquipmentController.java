...
public class EquipmentController {
    ...
    public ResponseEntity<StandardResponse> saveEquipment(@RequestBody EquipmentDTO equipmentDTO) {
        ...
        try {
            ...
            if (id.equals("00")) {//VarList eke aapu data tika thama mekata dala thiyanne
                ...
                return new ResponseEntity<StandardResponse>(new StandardResponse(201, id + "  Equipment Succesfully saved  : ", equipmentDTO), HttpStatus.CREATED);
            } else if (id.equals("06")) {
                return new ResponseEntity<StandardResponse>(new StandardResponse(401, id + "  Equipment Not saved  : ", id), HttpStatus.BAD_REQUEST);
            } else {
    ...
    public ResponseEntity<StandardResponse> updateEquipment(@RequestBody EquipmentDTO equipmentDTO) {
        try {
            ...
            if (id.equals("00")) {//VarList eke aapu data tika thama mekata dala thiyanne
                ...
                return new ResponseEntity<StandardResponse>(new StandardResponse(401, id + "  Equipment Not update  : ", id), HttpStatus.BAD_REQUEST);
            } else {
                return new ResponseEntity<StandardResponse>(new StandardResponse(501, id + " Error  : ", id), HttpStatus.BAD_REQUEST);
            }
        } catch (Exception e) {
    ...
    public ResponseEntity<StandardResponse> getAllEquipment() {
        try {
            ...
            return new ResponseEntity<StandardResponse>(new StandardResponse(200, " Succesfully get Equipments ", allEquipments), HttpStatus.ACCEPTED);
        } catch (Exception e) {
            return new ResponseEntity<StandardResponse>(new StandardResponse(601, " Error  : ", e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);//data ekak aluthen create karama create kiyala return karanawa
        }
    }
    ...
    public ResponseEntity<StandardResponse> findEquipmentByEquipmentId(@PathVariable("equipmentId") Long equipmentId) {
        try {
            ...
            if (equipmentDTO != null) {
                return new ResponseEntity<StandardResponse>(new StandardResponse(200, "   Succesfully get Equipment by Id  ", equipmentDTO), HttpStatus.ACCEPTED);
            } else {
                return new ResponseEntity<StandardResponse>(new StandardResponse(600, equipmentId + "  No Equipment is avilable on this id  : ", equipmentId), HttpStatus.BAD_REQUEST);
            }
        } catch (Exception e) {
            return new ResponseEntity<StandardResponse>(new StandardResponse(601, " Error  : ", e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseEntity<StandardResponse> deleteVehicle(@PathVariable("equipmentID") Long equipmentID) {
        try {
            ...
            if (res.equals("00")) {
                return new ResponseEntity<StandardResponse>(new StandardResponse(200, "  Equipment Succesfully delete by Id  ", equipmentID), HttpStatus.ACCEPTED);
            } else {
                return new ResponseEntity<StandardResponse>(new StandardResponse(600, equipmentID + "  No Equipment is avilable on this id  : ", equipmentID), HttpStatus.BAD_REQUEST);
            }
        } catch (Exception e) {
    ...
    public ResponseEntity<StandardResponse> getAllEquipmentIds() {
        try {
            ...
            return new ResponseEntity<>(new StandardResponse(200, "Successfully Retrieved Equipment IDs", equipmentIds), HttpStatus.OK);
        } catch (DataPersistException e) {
            return new ResponseEntity<>(new StandardResponse(400, "Failed to Retrieve Equipment IDs", null), HttpStatus.BAD_REQUEST);
        } catch (Exception e) {
